...
class ConfigUser{
  static  getData(AddUser addUser){
      addUser
          ...
          .addItem(User("1","ipul@gmail.com","1234","Bigjen Ipul Samudin, S.Hum.","Pasien","AIPDA","6637465723849572","08199233345934",4,1,[3,4]))
          .addItem(User("2","deno@gmail.com","1234","Kompol Deno Fambar, S.Kom","Pasien","AKP","28364627349012374","0899038828333",3,4,[1,5]))
          .addItem(User("3","juan@gmail.com","1234","AKBP Juan Aly Adi, S.Pi.","Pasien","BRIGPOL","5930310023457328","081992345692",4,2,[2,3,4]))
          .addItem(User("4","gege@gmail.com","1234","Pembina Gusti Agung Pratama, S.Kom","Pasien","BRIPTU","7293003047586921","021929222345",5,2,[2,3,4]))
          .addItem(User("5","lutfi@gmail.com","1234","Bigjen Lutfi Alghi Fahri, S.Ked","Pasien","BHARADA","53722282934500123","081229222950",3,4,[1,3,4]))
          .addItem(User("6","aghi@gmail.com","1234","Bigjen Adam Inzaghi, S.Kes.","Pasien","BHARAKA","0000293845723457","081922834772",2,5,[3,5]));
  }
